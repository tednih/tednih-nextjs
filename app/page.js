...
export default function Home() {
  return (
    <div className="h-screen flex items-center justify-center">
      <section className="text-center max-w-sm lg:max-w-lg hover:cursor-default">
        <h2 className="animate__animated animate__backInLeft text-2xl text-headline dark:text-darkheadline font-bold md:text-3xl">
          Hello, I'm Dimas <span className="underline">Ted</span>i S
        </h2>
        ...
        <p className="animate__animated animate__backInRight text-text dark:text-darktext mt-8">
          ...
          passion for solving problem and excited to learn new things. I also
          have experience in Fullstack Developer.
        </p>
      </section>
    </div>
  );
